...
function Achievements() {
    const achievements = [
        ...
        },
        {
          ...
          description:
            "Earned the Knight badge on LeetCode by consistently solving complex DSA problems and maintaining a solid streak."
        },
        {
          title: "GFG Institute 1st Rank",
          description:
            "Achieved 1st rank among institute peers on GeeksforGeeks by actively solving DSA problems and participating in coding contests."
        },
        {
