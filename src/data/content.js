...
export const experience = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Shipped Online Store features — settings, coupons, order details & activity, demo-store link, and WhatsApp support toggle.",
      "Added E-way Bill / E-Invoice enhancements — HSN codes, transporter ID, mandatory cancellation remarks, and frontend validations.",
      "Created reusable Compose design-system components — a Swipe custom text field and a Compose country-dial picker.",
      "Improved TDS/TCS search, thermal-print settings, expense list & category search, and multi-currency transaction filters.",
      "Fixed a wide range of production bugs across documents, payments, serial numbers, barcode scanning, and custom headers.",
    ],
  ...
  },
  {
    ...
    highlights: [
      "mifos-mobile (45+ PRs): migrated :core:ui, :core:datastore & :libs:passcode to KMP; moved Help, Savings, Settings & Location features to Compose Multiplatform.",
      "mifos-mobile screens: Transactions with filtering, Charges (paid/unpaid), Beneficiary management, Passcode & Password, and QR-code binding with savings & loan details.",
      "mobile-wallet: refined send-money, review-transfer, and home/transaction filtering in the KMP digital-wallet reference app.",
  ...
  },
  {
    ...
    highlights: [
      "Migrated :core:ui, :core:network & :core:dataStore to KMP, and moved Home Drawer, Activate, Search, Center & Collection Sheet modules to Compose Multiplatform.",
      "Redesigned client list, profile & profile-details UIs, plus client photo-update and staff assignment/unassignment flows.",
      "Built loan-account creation (details, terms & charges steps), client transfer/closure/collateral, and recurring-deposit & transaction-filter screens.",
      "Added type-safe navigation with breadcrumbs, empty/loading states, and resolved serialization errors across the data layer.",
    ],
